...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url()?>Backbone/profile/Profile#!<?php echo hash('sha256',$_SESSION['user'])?>">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?php echo base_url()?>Backbone/profile/Profile#!<?php echo hash('sha256',$_SESSION['user'])?>">
            ...
            <li class="nav-item">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo base_url()?>Passing/profile/persuratan/">PERSURATAN</a>
                    </div>
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Arsip Pengajuan MHS</h6>
                        <a class="collapse-item" href="<?php echo base_url()?>Backbone/detailpengajuan/1/<?php echo $_SESSION['idpegawai'];?>/search#!<?php echo hash('sha256',$_SESSION['user'])?>">MAGANG/PKL &nbsp;<span class="badge badge-danger badge-counter"><?php echo $alertmagangprodi;?></a>
                        <a class="collapse-item" href="<?php echo base_url()?>Passing/pengajuanskripsi/search#!<?php echo hash('sha256',$_SESSION['user'])?>">SKRIPSI</a>
                        <a class="collapse-item" href="<?php echo base_url()?>Backbone/outcountdatayudisium">YUDISIUM &nbsp;<span class="badge badge-danger badge-counter"><?php echo $alertyudisium;?></span></a>
                        <a class="collapse-item" href="<?php echo base_url()?>Backbone/pengajuansuratmhs/1/<?php echo $_SESSION['idpegawai'];?>/search#!<?php echo hash('sha256',$_SESSION['user'])?>">PENGAMBILAN DATA &nbsp;<span class="badge badge-danger badge-counter"><?php echo $alertambildata;?></span></a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <div id="collapseSurat" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo site_url('Persuratan/sso_surat');?>/<?php echo hash('sha256',$_SESSION['user'])?>/<?php echo $_SESSION['user'];?>" target="blank"><i class="fas fa-envelope"></i> PENTOR</a>
                        <a class="collapse-item" href="<?php echo site_url('Akreditasi/buktiborang')?>/<?php echo $_SESSION['idpegawai'];?>/search#!<?php echo hash('sha256',$_SESSION['user'])?>">Arsip Persuratan</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo base_url()?>API/controlmagang/<?php echo $_SESSION['idpegawai'];?>" target="blank">Control Magang/PKL</a>
                        <a class="collapse-item" href="<?php echo base_url();?>API/reportarsip">Control Data</a>
