            ...
            <li class="nav-item dropdown no-arrow mx-1">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo base_url()?>MHS/reportpengajuan/0/search#!<?php echo hash('sha256',$_SESSION['user'])?>">Magang / PKL <span class="badge badge-danger badge-counter"><?php echo $alertmagangprodi;?></span></a>
                        <a class="collapse-item" href="<?php echo base_url()?>MHS/reportpengambilandata/0/search#!<?php echo hash('sha256',$_SESSION['user'])?>">Pengambilan Data &nbsp;<span class="badge badge-danger badge-counter"><?php echo $alertambildata;?></span></a>
                       <a class="collapse-item" href="<?php echo base_url()?>Backbone/outcountdatayudisium/2">YUDISIUM &nbsp;<span class="badge badge-danger badge-counter"><?php echo $alertyudisium;?></span></a>
