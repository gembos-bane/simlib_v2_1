...
<body class="bg-gradient-primary" style="background-image: url'(<?php echo base_url() ?>asset/images/under.PNG)'; background-size: cover; background-repeat: no-repeat; background-attachment: fixed; background-position: center;">
</body>
