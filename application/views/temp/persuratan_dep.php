            ...
            <table class="table table-responsive">
                ...
                <tbody class="text-muted">
                    ...
                    <tr>
                        ...
                        <th scope="col-sm-4"><p class="text-capitalize"><?php echo $key['NO_SURAT'];?></p></th>
                        <th scope="col-sm-2"><p class="text-capitalize"><?php echo $key['TANGGAL_SURAT'];?></p></th>
                        <th scope="col-sm-2"><p class="text-capitalize"><?php echo $key['NAMA_PRODI'];?></p></th>
                        <th scope="col-sm-2"><p class="text-capitalize"><?php echo $key['PERIHAL_SURAT'];?></p></th>
                        <th scope="col-sm-3">
