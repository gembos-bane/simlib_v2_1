        ...
        <div class="container-fluid row col-sm-6">
            <?php echo form_open_multipart('Passing/searchsurat')?>
              <div class="row">
                ...
                <div class="col-sm-4">
                  <button type="button" class="btn btn-light bg-light"  data-bs-toggle="modal" data-bs-target="#Modal2"><text class="text-danger">Insert Surat Dinas</text></button>
                </div>
            ...
            <table class="table table-scroll">
                ...
                <tbody class="text-muted">
                    ...
                    <tr>
                        ...
                        <th scope="col-sm-11">
                            <button class="btn bg-info"><a style="text-decoration: none" href="<?php echo site_url('Passing/showall') ?>/persuratan/<?php echo $key['LOKASI_SURAT'];?>/pdf"><text class="text-white">View</text></a></button>
