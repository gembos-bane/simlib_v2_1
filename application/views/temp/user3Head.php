    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse active" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="<?php echo base_url()?>Passing/Profile/berkasFakultas/<?php echo $header[$a]; ?>/<?php echo $a+1;?>/profile#!<?php echo hash('sha256',$_SESSION['user'])?>"><?php echo $header[$a]; ?></a>
            </li>
            <?php } ?>
