 <nav class="navbar navbar-expand-lg navbar-light bg-light">
          <div class="container container-fluid">
            <ul class="navbar-nav">
              <li class="nav-item">
                <button type="button" class="btn btn-info"  data-bs-toggle="modal" data-bs-target="#Modal2">INSERT BERKAS SK</button>
              </li>
            </ul>
          </div>
    </nav>
            ...
            <table class="table table-striped">
                ...
                <tbody class="text-muted">
                    ...
                    <tr>
                        ...
                        <th scope="col-sm-11">
                            <a href="<?php echo site_url('Passing/showall') ?>/skmengajar/<?php echo $key['LOKASI_BERKAS'];?>"  target="_blank"><button class="btn btn-info">View</button></a>
