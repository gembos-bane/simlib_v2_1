        ...
        <div class="row p-2 m-2">
            <div class="col-sm-3">
              ...
              <figcaption class="blockquote-footer">
                Gelombang <cite title="Source Title">Pertama tanggal : </cite>
              </figcaption>
            </figure>
                    ...
                    <figure>
                      ...
                      <figcaption class="blockquote-footer">
                        Nilai <cite title="Source Title">SKP</cite>
                         ...
                         <p><?php echo $row['SYARAT_PGN_PEMASARAN']?></p>
                      </blockquote>
                      <figcaption class="blockquote-footer">
                        Nilai <cite title="Source Title">Nilai Mk Pengantar Pemasaran</cite>
                      </figcaption>
                    </figure>      
                    </figure> 
                         <p><?php echo $row['SYARAT_PGN_MANAJEMEN']?></p>
                      </blockquote>
                      <figcaption class="blockquote-footer">
                        Nilai <cite title="Source Title">Nilai Mk Pengantar Manajemen</cite>
                      </figcaption>
                    </figure>      
