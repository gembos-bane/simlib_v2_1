        ...
        <div class="row p-2 m-2">
            ...
            <ul class="list-unstyled list-hours mb-5 text-left mx-auto">
                    ...
                    <figure>
                      <blockquote class="blockquote">
                        <p><?php echo $row['SYARAT_KUP']?></p>
                      </blockquote>
                      <figcaption class="blockquote-footer">
                        Nilai <cite title="Source Title">NILAI KUP</cite>
                      </figcaption>
                    </figure>
                    <figure>
                      <blockquote class="blockquote">
                        <p><?php echo $row['SYARAT_POTPUTPPH']?></p>
                      </blockquote>
                      <figcaption class="blockquote-footer">
                        Nilai <cite title="Source Title">NILAI POTPUT PPH</cite>
                      </figcaption>
                    </figure> 

                    <figure>
                      <blockquote class="blockquote">
                        <p><?php echo $row['SYARAT_PPH']?></p>
                      </blockquote>
                      <figcaption class="blockquote-footer">
                        Nilai <cite title="Source Title">NILAI PPH</cite>
                      </figcaption>
                    </figure>
                    <figure>
                      <blockquote class="blockquote">
                        <p><?php echo $row['SYARAT_PPNBM']?></p>
                      </blockquote>
                      <figcaption class="blockquote-footer">
                        Nilai <cite title="Source Title">NILAI PPNBM</cite>
                      </figcaption>
                    </figure>     
