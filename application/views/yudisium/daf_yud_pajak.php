                                            ...
                                            <ul class="list-unstyled list-hours mb-5 text-left mx-auto">
                                                ...
                                                <li class="list-unstyled-item list-hours-item d-flex">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="ValidationCustom1" name="nohp">
                                                        </input>
                                                    </div>
                                                </li>
                                                <li class="list-unstyled-item list-hours-item d-flex">
                                                ...
                                                <li class="list-unstyled-item list-hours-item d-flex">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="ValidationCustom1" name="KUP" required>
                                                        </input>
                                                    </div>
                                                </li>
                                                <li class="list-unstyled-item list-hours-item d-flex">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="ValidationCustom1" name="poptut" required>
                                                        </input>
                                                    </div>
                                                </li>
                                                <li class="list-unstyled-item list-hours-item d-flex">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="ValidationCustom1" name="PPh" required>
                                                        </input>
                                                    </div>
                                                </li>
                                                <li class="list-unstyled-item list-hours-item d-flex">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="ValidationCustom1" name="PPNBM" required>
                                                        </input>
                                                    </div>
                                                </li>
                                                <li class="list-unstyled-item list-hours-item d-flex">
