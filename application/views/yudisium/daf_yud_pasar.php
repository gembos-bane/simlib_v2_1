                                            ...
                                            <ul class="list-unstyled list-hours mb-5 text-left mx-auto">
                                                ...
                                                <li class="list-unstyled-item list-hours-item d-flex">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="ValidationCustom1" name="pasar" required>
                                                        </input>
                                                    </div>
                                                </li>
                                                <li class="list-unstyled-item list-hours-item d-flex">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="ValidationCustom1" name="manajemen" required>
                                                        </input>
                                                    </div>
                                                </li>
