                                    ...
                                    <div class="col-xl-8 mx-auto">
                                        <div class="cta-inner bg-faded rounded">
                                            ...
                                            <ul class="list-unstyled list-hours mb-5 text-left mx-auto">
                                                ...
                                                <li class="list-unstyled-item list-hours-item d-flex">
                                                    <div class="input-group mb-3">
                                                        <span class="input-group-text" for="ValidationCustom1">Pengantar Pemasaran</span>
                                                        <input type="text" class="form-control" id="ValidationCustom1" name="pasar" value="<?php echo $value['SYARAT_PGN_PEMASARAN'] ?>">
                                                        </input>
                                                    </div>
                                                </li>
                                                <li class="list-unstyled-item list-hours-item d-flex">
                                                    <div class="input-group mb-3">
                                                        <span class="input-group-text" for="ValidationCustom1">Pengantar Manajemen</span>
                                                        <input type="text" class="form-control" id="ValidationCustom1" name="Manajemen" value="<?php echo $value['SYARAT_PGN_MANAJEMEN']; ?>">
                                                        </input>
                                                    </div>
                                                </li>
                                                <li class="list-unstyled-item list-hours-item d-flex">
